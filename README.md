...
**`ff/`** — GROMACS-compatible force field files corresponding to the **modified Seminario (mSEM) parametrization** selected in the paper after benchmarking against experimental densities, and used for all simulations. Note that CO$_2$ uses the flexible EMP2 force field
...
**`pdb/`** — PDB coordinate files for camphor, thymol, menthol, carvone, eucalyptol, and CO$_2$.
